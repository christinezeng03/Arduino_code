 ...
 *
 */
public class ShowBlinker extends Command {
	boolean executed = false;
	boolean finished = false;
	byte _addr, _count, _r, _g, _b, _interval;
	LED _led;

	   /**
	   * Command constructor
	   * @param led The subsystem for LED module   
	   ...
	   */				
    public ShowBlinker(LED led, byte addr, byte count, byte r, byte g, byte b, byte interval, double duration) {
    ...
    protected void initialize() {
		_led.show_blink(_addr, _count, (byte)_r, (byte)_g, (byte)_b, _interval);
		executed = true;
    }
